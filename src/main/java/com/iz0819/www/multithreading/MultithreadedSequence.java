...
public class MultithreadedSequence {
    ...
    public static void main(String[] args) {
        ...
        // Creating 3 threads
        Thread t1 = new Thread(new SeqRunnable(sp, 1), "com.iz0819.www.Thread1");
        Thread t2 = new Thread(new SeqRunnable(sp, 2), "com.iz0819.www.Thread2");
